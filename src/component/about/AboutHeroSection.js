    ...
    <div className="relative">
      ...
      <div className="flex flex-wrap relative">
            ...
            <header className="container px-4 lg:flex mt-10 items-center h-full lg:mt-0">
              <div className="w-full">
                <h1 className="text-2xl lg:text-3xl font-semibold capitalize">
                  A place where  <span className="text-orange-500">education meets innovation</span>, inspiring every child
                  to achieve greatness
                </h1>
                <div className="w-20 h-1 bg-green-700 my-4" />
                <p className="text-md mb-10">
        ...
        <img
          src={bgImage6}
          alt="Leafs"
          className="w-full h-36 object-cover sm:h-[96vh] sm:w-4/12"
        />
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-[1]">
        ...
        >
          <path
            ...
            fill="#FFFFFF" /* Change color to test visibility */
          ></path>
        </svg>
      </div>
    </div>
